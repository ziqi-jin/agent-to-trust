...
async function replyWithRetry(agent: A2tAgent, prompt: string): Promise<string> {
 ...
 */
async function runNegotiation(agent: A2tAgent, sc: NegotiationScenario): Promise<CaseResult> {
